                   ...
                   <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <td>
                           <a class="btn btn-success" onclick="confirmAction<?php echo $id;?>()">Approve</a>
                           <a class="btn btn-danger" onclick="confirmAction2<?php echo $id;?>()">Cancel</a>
                           ...
                           <script>
                            ...
                            function confirmAction<?php echo $id;?>() {
                              ...
                              if (confirmAction) {
                                window.location = "php/approve_studentrequest.php?id=<?php echo $id; ?>";
                              } 
                            }
                            ...
                            function confirmAction2<?php echo $id;?>() {
                              let confirmAction = confirm("Are you sure to execute this action?");
                              if (confirmAction) {
                                window.location = "php/delete_program.php?id=<?php echo $id;?>";
                              } 
                            }
                          </script>
